<template>
  <div id="app">
    ...
    <section class="page-header">
      ...
      <a href="https://github.com/hinesboy/mavonEditor" class="btn"
        >View on GitHub</a
      >
      <a
        ...
        >Download .zip</a
      >
      <a href="https://github.com/hinesboy/mavonEditor/master" class="btn"
        >Download .tar.gz</a
      >
    </section>
      ...
      <div class="item-button">
        ...
        <div class="switch-code-style">
          ...
          <select v-model="codeStyle">
            <option v-for="(val, key) in styles" :value="key" :key="key">
              {{ key }}
            </option>
          </select>
        </div>
    ...
    <div class="item">
      <h2 class="item-header">
        {{ d_words.detail
        }}<a href="https://github.com/hinesboy/mavonEditor">GitHub</a>
      </h2>
    </div>
  </div>
</template>
